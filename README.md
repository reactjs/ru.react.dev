...
1. `git checkout master` из любой директории в вашей локальной копии репозитория `ru.reactjs.org`
...
1. Сохраните файлы и проверьте в вашем браузере
  ...
  1. При работе с плагинами может понадобится удаление директории `.cache` и перезапуск сервера
