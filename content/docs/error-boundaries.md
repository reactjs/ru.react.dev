...
Предохранители работают как `catch {}` JavaScript-блоки, но только для компонентов. Только классовые компоненты могут выступать в роли предохранителей. На практике, чаще всего целесообразным будет один раз описать предохранитель и дальше использовать его по всему приложению.
...
Это изменение означает, что при мигрировании на React 16, вы с большой вероятностью натолкнётесь на незамеченные ранее ошибки в вашем приложении. Добавляя в ваше приложение предохранители, вы получаете возможность обеспечивать более высокое качество взаимодействия с приложением (user experience) при возникновении ошибок.
...
Также, мы призываем пользоваться сервисами обработки ошибок JS (или написать ваш собственный аналогичный сервис) с тем, чтобы вы оказывались в курсе и могли устранять неотловленные исключения по мере их появления, ещё в продакшен-режиме.
