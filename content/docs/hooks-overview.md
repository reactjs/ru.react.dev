...
Хуки дают вам возможность размещать побочные эффекты в компоненте согласно вещам, к которым они относятся (например добавление или отмена подписки), вместо того, чтобы принуждать вас делить все согласно методам жизненного цикла.
...
## 💡 Создание ваших собственных хуков {#-building-your-own-hooks}
...
А хук [`useReducer`](/docs/hooks-reference.html#usereducer) дает вам возможность управлять внтуренним состоянием более сложного компонента с помощью редюсера.
