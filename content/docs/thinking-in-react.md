...
Давайте рассмотрим данные по частям и определим, что должно храниться в состоянии. Задайте себе три вопроса:
  ...
  1. Передаются ли они от родителя через пропсы? Тогда эти данные не должны храниться в состоянии компонента.
  2. Остаются ли они неизменными со временем? Тогда их тоже не следует хранить в состоянии.
  3. Можете ли вы вычислить их на основании любых других данных в своём компоненте или пропсов? Тогда это тоже не состояние.
