...
Давайте рассмотрим каждую часть данных и определим, какую из них нужно хранить в состоянии. Задайте себе следующие три вопроса:
  ...
  2. Остаётся ли она неизменной со временем? Тогда они тоже не должны храниться в состоянии.
  3. Можете ли вы вычислить её на основании любой другой части состояния или пропсов в своём компоненте? Тогда это тоже не состояние.
