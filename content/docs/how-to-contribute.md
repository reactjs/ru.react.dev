...
Для того, чтобы выпускать релизы из ветки `master`, изменения, ломающие обратную совместимость, и экспериментальная функциональность могут быть применены в зависимости от значений флагов функций.
