...
Некоторые пользователи считают книги или видеокурсы от сторонних авторов более полезными, нежели официальная документация. Для них мы разместили [список рекомендуемых ресурсов](/community/courses.html). Часть этих ресурсов бесплатны.
