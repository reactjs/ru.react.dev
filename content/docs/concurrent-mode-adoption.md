...
>Внимание:
>
>На странице описаны **экспериментальные функции, которых еще нет в стабильной версии**. Не используйте экспериментальные сборки React в продакшн приложениях. Эти функции могут значительно измениться без предупреждения перед тем, как попасть в React.
>
>Эта документация нацелена на ранних интеграторов и любопытных пользователей. Если вы новичок в React, не беспокойтесь об этих функциях, не нужно изучать их прямо сейчас.
...
Экспериментальные релизы, в основном, предназначены для ранних интеграторов, разработчиков библиотек или для любопытных пользователей.
