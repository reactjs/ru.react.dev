...
Когда что-то идёт не так, важно иметь возможность найти источник ошибки в кодовой базе. В React помогают это сделать свойства и состояние.
