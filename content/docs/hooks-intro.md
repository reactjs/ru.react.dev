...
Мы начнём изучение с первого «хука» — функции `useState`. Не беспокойтесь, если этот пример сначала выглядит непонятно. Мы скоро разберёмся, как он работает.
...
* **Полностью на ваше усмотрение.** Вы можете попробовать хуки в некоторых компонентах, не изменяя код в уже существующих. Хуки не обязательно использовать или изучать прямо сейчас.
