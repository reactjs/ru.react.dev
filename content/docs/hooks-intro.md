...
* **Полностью на ваше усмотрение.** Вы можете попробовать хуки в нескольких компонентах, не изменяя код в уже существующих. Если не хотите, то можете не использовать хуки прямо сейчас.
