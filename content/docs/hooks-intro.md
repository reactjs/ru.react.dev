...
На конференции React Conf 2018, Софи Алперт (Sophie Alpert) и Дэн Абрамов (Dan Abramov) представили хуки, а затем Райн Флоренс (Ryan Florence) показал, как с их помощью переписать ваше приложение. Видео конференции можно посмотреть здесь:

<br>

<iframe width="650" height="366" src="//www.youtube.com/embed/dpw9EHDh2bM" frameborder="0" allowfullscreen></iframe>

## Обратная совместимость сохранена {#no-breaking-changes}
