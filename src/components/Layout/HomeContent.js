      ...
      <div className="ps-0">
        ...
        <Section background="right-card">
          <Center>
            ...
            <Para>
              React — это библиотека. Она позволяет соединять компоненты вместе,
              но не предписывает, как выполнять маршрутизацию и загрузку данных.
              Чтобы построить всё приложение с React, мы рекомендуем
              взять фулстек-фреймворк, например,{' '}
