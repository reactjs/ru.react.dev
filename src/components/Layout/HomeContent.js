    ...
    <>
      <div className="ps-0">
        ...
        <Section background="left-card">
          <Center>
            ...
            <Para>
              ...
              частей, называемых компонентами. Создавай собственные компоненты
              React, например <Code>Thumbnail</Code>, <Code>LikeButton</Code>, и{' '}
              <Code>Video</Code>. Затем объединяйте их в целые экраны, страницы,
              и приложения.
            </Para>
          </Center>
          <FullBleed>
          ...
          <Center>
            <Para>
              ...
              других разработчиков, использование React будет таким же. Он
              создан для того, чтобы вы могли легко комбинировать компоненты,
        ...
        <Section background="right-card">
          <Center>
            <Header>Написание компонентов с помощью кода и разметки</Header>
            <Para>
              Компоненты React - это функции JavaScript. Хотите условно показать
              некоторый контент? Используйте оператор <Code>if</Code>. Выводите
              список? Попробуйте использовать массив <Code>map()</Code>.
          ...
          <Center>
            <Para>
              ...
              JavaScript, популяризированное в React. Размещение разметки JSX
              рядом со связанной с ней логикой рендеринга упрощает создание,
              поддержку и удаление компонентов React.
            </Para>
          </Center>
        </Section>
        ...
        <Section background="left-card">
          <Center>
            ...
            <Para>
              ...
              на взаимодействие, например, когда пользователь вводит текст в
              поле ввода. Тогда React обновит экран в соответствии с новыми
              данными.
            </Para>
          </Center>
          <FullBleed>
          ...
          <Center>
            <Para>
              Вам не нужно создавать всю страницу на React. Добавьте React на
              существующую HTML-страницу и создайте интерактивные компоненты
              React в любом ее месте.
            </Para>
        ...
        <Section background="right-card">
          <Center>
            <Header>
              Перейдите на full-stack <br className="hidden lg:inline" />с
              помощью фреймворка
            </Header>
            <Para>
              React - это библиотека. Она позволяет собирать компоненты вместе,
              но не предписывает, как выполнять маршрутизацию и получение
              данных. Чтобы создать целое приложение на React, мы рекомендуем
              использовать полнофункциональный React-фреймворк, например{' '}
          ...
          <Center>
            <Para>
              React - это также архитектура. Фреймворки, реализующие ее,
              позволяют получать данные в асинхронных компонентах, которые
              запускаются на сервере или даже во время сборки. Считывайте данные
              из файла или базы данных и передавайте их интерактивным
              компонентам.
            </Para>
            <div className="flex justify-start w-full lg:justify-center">
              <CTA
        ...
        <Section background="left-card">
          <div className="mx-auto flex flex-col w-full">
            <div className="mx-auto max-w-4xl lg:text-center items-center px-5 flex flex-col">
              <Header>Используйте лучшее от каждой платформы</Header>
              <Para>
                Люди любят веб-приложения и нативные приложения по разным
                причинам. React позволяет создавать и веб-приложения, и нативные
                приложения, используя одни и те же навыки. Он опирается на
                уникальные преимущества каждой платформы, чтобы ваши интерфейсы
                чувствовали себя комфортно на каждой из них.
              </Para>
            </div>
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="relative flex items-start justify-center flex-col flex-1 pb-16 pt-5 gap-3 px-5 lg:px-10 lg:pt-8">
                      ...
                      <p className="lg:text-xl leading-normal text-secondary">
                        ...
                        загружаться быстро. На сервере React позволяет начать
                        потоковую передачу HTML еще во время получения данных,
                        постепенно заполняя оставшийся контент до загрузки кода
                        JavaScript. На клиенте React может использовать
                        стандартные веб-интерфейсы API, чтобы сохранить
                        отзывчивость пользовательского интерфейса даже в
                        процессе рендеринга.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="bg-gradient-right dark:bg-gradient-right-dark px-3 sm:px-3 pb-12 lg:pb-20 rounded-lg overflow-hidden">
                      ...
                      <div className="flex flex-col items-start justify-center pt-0 gap-3 px-2.5 lg:pt-8 lg:px-8">
                        <h4 className="leading-tight text-primary dark:text-primary-dark font-semibold text-3xl lg:text-4xl">
                          Станьте по-настоящему нативным
                        </h4>
                        <p className="h-full lg:text-xl text-secondary dark:text-secondary-dark leading-normal">
                          Люди ожидают, что нативные приложения будут выглядеть
                          и ощущаться как их платформа.{' '}
                          <Link href="https://reactnative.dev">
                            React Native
                          </Link>{' '}
                          и{' '}
                          <Link href="https://github.com/expo/expo">Expo</Link>{' '}
                          позволяют создавать приложения на React для Android,
                          iOS и других платформ. Они выглядят и ощущаются как
                          нативные, потому что их UI <i>действительно</i>{' '}
                          нативный. Это не веб-видение - ваши компоненты React
            ...
            <div className="px-5 lg:px-0 max-w-4xl mx-auto lg:text-center text-secondary dark:text-secondary-dark">
              <Para>
                С React вы можете быть как веб-разработчиком, так <i>и</i>{' '}
                нативным разработчиком. Ваша команда может работать на многих
                платформах без ущерба для пользовательского опыта. Ваша
                организация может преодолеть разделение платформ и сформировать
                команды, владеющие всеми функциями от начала до конца.
              </Para>
              <div className="flex justify-start w-full lg:justify-center">
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row px-5">
            <div className="max-w-3xl lg:max-w-7xl gap-5 flex flex-col lg:flex-row lg:px-5">
              <div className="w-full lg:w-6/12 max-w-3xl flex flex-col items-start justify-start lg:ps-5 lg:pe-10">
                <Header>Обновляйтесь, когда будущее будет готово</Header>
                <Para>
                  React подходит к изменениям с осторожностью. Каждый коммит
                  React тестируется на критически важных для бизнеса
                  поверхностях с более чем миллиардом пользователей. Более 100
                  000 компонентов React в Meta помогают проверить каждую
                  стратегию миграции.
                </Para>
                <div className="order-last pt-5">
                  <Para>
                    Команда React постоянно исследует, как улучшить React.
                    Некоторые исследования занимают годы, чтобы окупиться. У
                    React высокая планка для внедрения исследовательской идеи в
                    производство. Только проверенные подходы становятся частью
                    React.
                  </Para>
                  <div className="hidden lg:flex justify-start w-full">
                    <CTA color="gray" icon="news" href="/blog">
                      Читать другие новости о React
                    </CTA>
                  </div>
                </div>
              </div>
        ...
        <Section background="left-card">
          <div className="w-full">
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Header>
                  Присоединяйтесь к <br className="hidden lg:inline" />
                  миллионному сообществу
                </Header>
                <Para>
                  Вы не одиноки. Два миллиона разработчиков со всего мира
                  посещают документацию React каждый месяц. React - это то, с
                  чем люди и команды могут согласиться.
                </Para>
              </Center>
            </div>
            <CommunityGallery />
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Para>
                  Именно поэтому React - это больше, чем библиотека, архитектура
                  или даже экосистема. React - это сообщество. Это место, где вы
                  можете попросить помощи, найти возможности и встретить новых
                  друзей. Здесь вы встретите разработчиков и дизайнеров,
                  новичков и экспертов, исследователей и художников,
                  преподавателей и студентов. Наш опыт может быть очень разным,
