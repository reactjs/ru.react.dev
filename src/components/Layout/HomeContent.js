    ...
    <>
      <div className="ps-0">
        ...
        <Section background="left-card">
          ...
          <Center>
            <Para>
              ...
              независимыми людьми, командами, организациями.
            </Para>
          </Center>
        </Section>
        ...
        <Section background="right-card">
          <Center>
            ...
            <Para>
              ...
              <Code>map()</Code>. Изучение React — это изучение
              программирования.
            </Para>
          </Center>
          <FullBleed>
          ...
          <Center>
            <Para>
              ...
              разметки JSX с логикой рендеринга упрощает создание, поддержку и
              удаление React-компонентов
            </Para>
          </Center>
        </Section>
        ...
        <Section background="left-card">
          <Center>
            ...
            <Para>
              ...
              на взаимодействие, например, когда пользователь что-то вводит,
              когда пользователь печатает в поле ввода, когда пользователь
              заполняет форму. Затем React обновит экран, чтобы соответствовать
              новым данным.
            </Para>
          </Center>
          <FullBleed>
        ...
        <Section background="right-card">
          <Center>
            <Header>
              Использовать фреймворк для фулстек-решения{' '}
              <br className="hidden lg:inline" />
            </Header>
            <Para>
              React — это один из фулстек-фреймворков, например, Next.js или
              Remix. Он позволяет соединять компоненты вместе, но не
              предписывает, как выполнять маршрутизацию и загрузку данных. Чтобы
              построить всё приложение с React, мы рекомендуем
              полнофункциональную среду React примере{' '}
          ...
          <Center>
            <Para>
              ...
              позволяют вам получать данные в асинхронных компонентах, которые
              работают на сервере или даже во время сборки. Читать данные из
              файла или базы данных и передает его своим интерактивным
              компонентам.
            </Para>
            <div className="flex justify-start w-full lg:justify-center">
              <CTA
          ...
          <div className="mx-auto flex flex-col w-full">
            <div className="mx-auto max-w-4xl lg:text-center items-center px-5 flex flex-col">
              ...
              <Para>
                ...
                сильные стороны каждой платформы, чтобы интерфейс подходил любым
                платформам.
              </Para>
            </div>
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="relative flex items-start justify-center flex-col flex-1 pb-16 pt-5 gap-3 px-5 lg:px-10 lg:pt-8">
                      <h4 className="leading-tight text-primary font-semibold text-3xl lg:text-4xl">
                        Оставайтесь верными вебу
                      </h4>
                      <p className="lg:text-xl leading-normal text-secondary">
                        Люди ожидают, что страницы веб-приложений будут
                        загружаться быстро. На сервере React позволяет вам
                        начать потоковую передачу HTML, пока вы извлекаете
                        данные, перед загрузкой любого JavaScript кода, она
                        постепенно заполняет оставшееся содержимое. На клиенте
                        React может использовать стандартный веб-API, чтобы
                        сохранить ваш пользовательский интерфейс отзывчивым даже
                        при рендеринге.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="bg-gradient-right dark:bg-gradient-right-dark px-3 sm:px-3 pb-12 lg:pb-20 rounded-lg overflow-hidden">
                      ...
                      <div className="flex flex-col items-start justify-center pt-0 gap-3 px-2.5 lg:pt-8 lg:px-8">
                        <h4 className="leading-tight text-primary dark:text-primary-dark font-semibold text-3xl lg:text-4xl">
                          Оставайтесь по-настоящему нативными
                        </h4>
            ...
            <div className="px-5 lg:px-0 max-w-4xl mx-auto lg:text-center text-secondary dark:text-secondary-dark">
              <Para>
                С React вы можете быть веб <i>и</i> нативным разработчиком. Ваша
                команда может работать на многих платформах без ущерба для
                пользовательского опыта. Ваша организация может соединить
            ...
            <div className="max-w-3xl lg:max-w-7xl gap-5 flex flex-col lg:flex-row lg:px-5">
              <div className="w-full lg:w-6/12 max-w-3xl flex flex-col items-start justify-start lg:ps-5 lg:pe-10">
                ...
                <Para>
                  ...
                  React проверен на критически важных для бизнеса системах с
                  более чем миллиардом пользователей. Более 100 000 компонентов
                  React в Meta помогают проверить каждую миграционную стратегию.
                </Para>
                <div className="order-last pt-5">
                  ...
                  <div className="hidden lg:flex justify-start w-full">
                    <CTA color="gray" icon="news" href="/blog">
                      Читать свежие новости про React
                    </CTA>
                  </div>
                </div>
              </div>
            ...
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                ...
                <Para>
                  ...
                  месяц посещает документацию React. React - это точка
                  соприкосновения людей (разработчиков?) и команд
                </Para>
              </Center>
            </div>
            <CommunityGallery />
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Para>
                  ...
                  новыми друзьями. Вы встретите как разработчиков, так и
                  дизайнеров, новичков и экспертов, исследователей и художников,
                  преподавателей и студентов. У нас может быть очень разный
                  опыт, но React позволяет нам всем вместе создавать
