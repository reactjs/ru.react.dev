        ...
        <Section background="left-card">
          <Center>
            ...
            <Para>
              ...
              на взаимодействие, например, когда пользователь что-то вводит в
              поле ввода. Затем React обновит экран, чтобы соответствовать новым
              данным.
            </Para>
          </Center>
          <FullBleed>
            ...
            <div className="max-w-3xl lg:max-w-7xl gap-5 flex flex-col lg:flex-row lg:px-5">
              ...
              <div className="w-full lg:w-6/12">
                ...
                <div className="flex lg:hidden justify-start w-full">
                  <CTA color="gray" icon="news" href="/blog">
                    Читать больше новостей про React
                  </CTA>
                </div>
              </div>
            </div>
            ...
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                ...
                <Para>
                  ...
                  соприкосновения разработчиков и команд.
                </Para>
              </Center>
            </div>
            <CommunityGallery />
