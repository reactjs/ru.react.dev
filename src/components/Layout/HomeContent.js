      ...
      <div className="ps-0">
        ...
        <Section background="left-card">
          ...
          <Center>
            <Para>
              React позволяет создавать пользовательский интерфейс из отдельных
              компонентов, независимо от того, работаете ли вы самостоятельно
              или с тысячами других сотрудников. Он разработан таким образом,
              чтобы вы могли легко комбинировать компоненты, написанные
              независимыми людьми, командами и организациями.
            </Para>
          </Center>
        </Section>
        ...
        <Section background="right-card">
          <Center>
            <Header>
              Full-stack <br className="hidden lg:inline" />с помощью фреймворка
            </Header>
            <Para>
              React является библиотекой. Она позволяет вам собирать компоненты
              вместе, но она не указывает, как создавать маршрутизацию и
              получение данных. Чтобы создать целое приложение с React, мы
              рекомендуем использовать фреймворк React, например{' '}
          ...
          <div className="mx-auto flex flex-col w-full">
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="relative flex items-start justify-center flex-col flex-1 pb-16 pt-5 gap-3 px-5 lg:px-10 lg:pt-8">
                      ...
                      <p className="lg:text-xl leading-normal text-secondary">
                        Люди ожидают, что веб-приложения будут загружаться
                    ...
                    <div className="bg-gradient-right dark:bg-gradient-right-dark px-3 sm:px-3 pb-12 lg:pb-20 rounded-lg overflow-hidden">
                      ...
                      <div className="flex flex-col items-start justify-center pt-0 gap-3 px-2.5 lg:pt-8 lg:px-8">
                        ...
                        <p className="h-full lg:text-xl text-secondary dark:text-secondary-dark leading-normal">
                          Люди ожидают, что приложения будут выглядеть и
                          ощущаться также, как и на их платформе.{' '}
                          <Link href="https://reactnative.dev">
                            React Native
                          </Link>{' '}
                          и{' '}
                          <Link href="https://github.com/expo/expo">Expo</Link>{' '}
                          позволяют вам создавать приложения в React для
            ...
            <div className="px-5 lg:px-0 max-w-4xl mx-auto lg:text-center text-secondary dark:text-secondary-dark">
              <Para>
                ...
                разработчиком для нативных платформ. Ваша команда может
                выпускать приложения на многих платформах без ущерба для
                пользовательского опыта. Ваша организация может объединить
                отдельные платформы и сформировать команды, которые будут
                полностью владеть всем функционалом.
              </Para>
              <div className="flex justify-start w-full lg:justify-center">
                <CTA color="gray" icon="native" href="https://reactnative.dev/">
                  Создать приложение для нативных платформ
                </CTA>
              </div>
            </div>
          </div>
