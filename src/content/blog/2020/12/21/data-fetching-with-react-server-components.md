...
2020 год был долгим. Поскольку он подходит к концу, мы хотели поделиться специальным праздничным обновлением о наших исследованиях **React Server Components** с нулевым размером бандла.
...
**React Server Components всё ещё находятся на стадии исследований и разработок.** Мы делимся этой работой в духе прозрачности и для получения первоначальных отзывов от сообщества React. Для этого будет достаточно времени, поэтому **не чувствуйте, что вам нужно наверстывать прямо сейчас!**
