...
author: Ricky Hanlon
date: 2024/05/22
description: На прошлой неделе мы провели React Conf 2024, двухдневную конференцию в Хендерсон, Невада, где более 700 участников собрались лично, чтобы обсудить последние достижения в области UI-инженерии. В этом посте мы кратко изложим доклады и анонсы с мероприятия.
---
...
В основной доклад первого дня [Joe Savona](https://twitter.com/en_JS) поделился нашими целями и видением React, чтобы любому было легко создавать отличные пользовательские интерфейсы. Затем [Lauren Tan](https://twitter.com/potetotes) представила доклад "State of React", в котором сообщила, что в 2023 году React был загружен более 1 миллиарда раз, а 37% новых разработчиков начинают изучать программирование с React. Наконец, она подчеркнула работу сообщества React по развитию React.
...
Далее в основной части доклада [Josh Story](https://twitter.com/joshcstory) и [Andrew Clark](https://twitter.com/acdlite) рассказали о новых функциях, которые появятся в React 19, и анонсировали React 19 RC, готовый к тестированию в продакшене. Ознакомьтесь со всеми функциями в [посте о релизе React 19](/blog/2024/12/05/react-19) и посмотрите эти доклады для более глубокого изучения новых функций:
...
В завершение основной части доклада [Joe Savona](https://twitter.com/en_JS), [Sathya Gunasekaran](https://twitter.com/_gsathya) и [Mofei Zhang](https://twitter.com/zmofei) объявили, что React Compiler теперь [Open Source](https://github.com/facebook/react/pull/29061), и представили экспериментальную версию React Compiler для ознакомления.
...
Полную запись основного доклада первого дня смотрите здесь:
...
В основной доклад второго дня [Nicola Corti](https://twitter.com/cortinico) представил "State of React Native", сообщив о 78 миллионах загрузок в 2023 году. Он также упомянул приложения, использующие React Native, включая более 2000 экранов, используемых внутри Meta; страницу с деталями продукта в Facebook Marketplace, которую посещают более 2 миллиардов раз в день; а также часть меню "Пуск" в Microsoft Windows и некоторые функции почти всех продуктов Microsoft Office на мобильных и настольных устройствах.
...
[Riccardo Cipolleschi](https://twitter.com/cipolleschir) продолжил основной доклад второго дня, объявив, что новая архитектура React Native теперь находится в бета-версии и готова к использованию в продакшене. Он рассказал о новых функциях и улучшениях в новой архитектуре, а также представил дорожную карту развития React Native. Дополнительно ознакомьтесь:
...
Далее в основной части доклада Nicola объявил, что теперь мы рекомендуем начинать разработку новых приложений с React Native с использованием фреймворков, таких как Expo. Вместе с этим изменением он анонсировал новую главную страницу React Native и обновленную документацию по началу работы. Вы можете ознакомиться с новым руководством по началу работы в [документации React Native](https://reactnative.dev/docs/next/environment-setup).

В заключение основной части доклада [Kadi Kraman](https://twitter.com/kadikraman) представила последние функции и улучшения в Expo, а также рассказала, как начать разработку с React Native с использованием Expo.

Полную запись основного доклада второго дня смотрите здесь:
...
Спасибо всем сотрудникам, докладчикам и участникам, которые сделали React Conf 2024 возможной. Перечислить всех невозможно, но мы хотим выразить особую благодарность некоторым.
...
Спасибо [Seth Webster](https://twitter.com/sethwebster) и [Eli White](https://x.com/Eli_White) за приветствия каждый день и за руководство по структуре и содержанию; а также [Tom Occhino](https://twitter.com/tomocchino) за специальное сообщение во время афтерпати.

Спасибо [Ricky Hanlon](https://www.youtube.com/watch?v=FxTZL2U-uKg&t=1263s) за предоставление подробных отзывов о докладах, работу над дизайном слайдов и в целом за заполнение пробелов и внимание к деталям.
