...
description: На прошлой неделе мы провели React Conf 2024, двухдневную
  конференцию в Хендерсон, Невада, где более 700 участников собрались лично,
  чтобы обсудить последние достижения в области UI-инженерии. В этом посте мы
  кратко изложим доклады и анонсы с мероприятия.
---
