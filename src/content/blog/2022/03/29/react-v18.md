...
date: 2022/03/08
description: React 18 теперь доступен в npm! В нашем последнем посте мы
  поделились пошаговыми инструкциями по обновлению вашего приложения до React
  18. В этом посте мы рассмотрим, что нового появилось в React 18 и что это
  значит для будущего.
---
