...
Вашим компонентам нужно будет часто отображать различные вещи в зависимости от различных условий. В React вы можете реденрить JSX в зависимости от его условий, используя JavaScript операторы. Такие, как `if`, `&&` и `? :`
...
- Общий условный синтаксис, которые вы встретите в кодовой базе React.

</YouWillLearn>

## Условно возвращаемый JSX {/_conditionally-returning-jsx_/}

Допустим, у вас есть `PackingList` компонент, который рендерит несколько `Item`ов, которые могут быть обозначены, как упакованные или неуправкованные:
