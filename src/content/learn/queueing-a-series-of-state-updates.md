...
* **Любое другое значение** (напр. число `5`) добавляет "заменить на `5`" в очередь, игнорируя то, что уже было запланировано.
