...
Если вы столкнулись с задачами, неподдерживаемыми существующими фреймворками, предпочитаете собственное решение или хотите получше изучить основы React-приложений, вы можете [создать React-приложение с нуля](/learn/build-a-react-app-from-scratch).
...
**[Next.js (Next.js App Router)](https://nextjs.org/docs) -- React-фреймворк, полностью использующий преимущества архитектуры React для создания фулстек-приложений.
...
## Создания React-приложения с нуля {/*start-from-scratch*/}
