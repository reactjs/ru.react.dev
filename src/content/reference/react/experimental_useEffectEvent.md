...
`useEffectEvent` — это React Hook, который позволяет вам выносить нереактивную логику в [Событие эффекта.](/learn/separating-events-from-effects#declaring-an-effect-event)
