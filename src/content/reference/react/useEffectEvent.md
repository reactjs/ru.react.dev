...
Возвращает функцию Effect Event, которую можно вызывать внутри `useEffect`, `useLayoutEffect` или `useInsertionEffect`.
...
Когда вы используете реактивные значения (пропсы или состояние) внутри эффекта,
